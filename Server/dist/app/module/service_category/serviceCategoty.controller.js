...
const getAllServiceCategory = (0, catchAsync_1.default)(async (req, res) => {
    const result = await serviceCategory_service_1.ServiceCategoryService.getAllServiceCategory();
    (0, sendResponse_1.default)(res, {
        success: true,
